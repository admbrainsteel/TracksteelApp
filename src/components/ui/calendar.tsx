    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100"
        ),
        ...
        day_outside:
          "day-outside text-gray-500 dark:text-gray-400 opacity-50 aria-selected:bg-gray-100 dark:aria-selected:bg-gray-700 aria-selected:text-gray-500 dark:aria-selected:text-gray-400 aria-selected:opacity-30",
        day_disabled: "text-gray-400 dark:text-gray-500 opacity-50",
        day_range_middle:
          "aria-selected:bg-gray-100 dark:aria-selected:bg-gray-700 aria-selected:text-gray-900 dark:aria-selected:text-gray-100",
