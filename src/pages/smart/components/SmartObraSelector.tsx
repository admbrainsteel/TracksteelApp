  ...
  return (
    <div className="flex flex-col flex-1 p-4 max-w-xl mx-auto w-full">
      ...
      <div className="mb-4 text-center">
        <div className="inline-flex p-3 rounded-2xl bg-amber-100 dark:bg-amber-500/10 text-amber-800 dark:text-amber-400 border border-amber-300 dark:border-amber-500/20 mb-2">
      ...
      <div className="relative mb-5">
        <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-amber-700 dark:text-amber-400">
        ...
        <Input
          ...
          className="h-14 pl-11 pr-11 bg-white dark:bg-slate-800/90 border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 text-base font-medium rounded-2xl focus-visible:ring-amber-500 focus-visible:border-amber-500 shadow-sm"
        />
        {busca && (
          <button
            type="button"
      ...
      <div className="flex-1 overflow-y-auto space-y-3 pb-8">
        {isLoading ? (
          ...
          <div className="p-8 text-center bg-white dark:bg-slate-800/40 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <AlertCircle className="h-10 w-10 text-amber-600 dark:text-amber-500/60 mx-auto mb-2" />
            <h3 className="text-base font-bold text-slate-800 dark:text-slate-200">Nenhuma obra encontrada</h3>
          ...
          filteredOFs.map((of) => (
            <button
              ...
              className="w-full min-h-[72px] p-4 rounded-2xl bg-white hover:bg-amber-50/60 active:bg-amber-100/60 dark:bg-slate-800/90 dark:hover:bg-slate-750 dark:active:bg-slate-700 border-2 border-slate-200 hover:border-amber-400/80 dark:border-slate-700/80 dark:hover:border-amber-500/60 transition-all flex items-center justify-between text-left gap-3 shadow-sm active:scale-[0.98] group"
            >
              <div className="flex items-center gap-3.5 min-w-0">
                <div className="h-12 w-12 rounded-xl bg-amber-100 text-amber-800 dark:bg-slate-700/80 dark:text-amber-400 group-hover:bg-amber-500 group-hover:text-white dark:group-hover:text-slate-950 transition-colors shrink-0 flex items-center justify-center">
                  <Building className="h-6 w-6" />
                </div>
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="text-base font-black text-amber-700 dark:text-amber-400 tracking-wider">
                      OF {of.of_number}
                    </span>
                  </div>
              ...
              <ChevronRight className="h-6 w-6 text-slate-400 group-hover:text-amber-600 dark:text-slate-500 dark:group-hover:text-amber-400 transition-colors shrink-0" />
            </button>
          ))
        )}
      </div>
